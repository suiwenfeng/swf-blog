...
const StaticSiteMap = require('broccoli-static-site-map');
...
//       this.ui.writeWarnLine(`You have not set paginate to 'true' or 'false' in your blog config. In the next major version of swf-blog this will default to true
//
...
//     }
    ...
    if(!existsSync(tagFolder)) {
      this.ui.writeWarnLine(`As of swf-blog@1.7 you must define your tags in the same way as you define your authors. We will auto generate tag files for you but this behaviour will be removed in swf-blog@2.0.
...
Please generate tags using 'ember generate tag your-tag-name'`);
    ...
    if (blogConfig.host) {
      trees.push(new StaticSiteMap(contentTree, {
      ...
      if(this.ui) {
        this.ui.writeWarnLine(`Host is not configured so no RSS feed will be generated
          ...
          https://github.com/suiwenfeng/swf-blog#configuring-your-host--enabling-rss`);
      }
    }
